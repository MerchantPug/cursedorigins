package io.github.merchantpug.cursedorigins.action;
...
public class LiteralCreeperExplodeAction {
    ...
    public static ActionFactory<Entity> getFactory() {
        return new ActionFactory<>(CursedOrigins.identifier("literal_creeper_explode"), new SerializableData()
                ...
                LiteralCreeperExplodeAction::action
        );
    }
}